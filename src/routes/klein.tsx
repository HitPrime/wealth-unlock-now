    ...
    <div style={{
      ...
      <main style={{
        ...
        >
          ...
          <button
            onClick={() => {
              const v = document.getElementById("klein-video") as HTMLVideoElement;
              if (v) { v.muted = !v.muted; (document.getElementById("klein-unmute") as HTMLElement).innerText = v.muted ? "🔇 Tap for sound" : "🔊 Sound on"; }
            }}
            id="klein-unmute"
            style={{
