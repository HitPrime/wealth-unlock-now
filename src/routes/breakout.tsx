  ...
  const features = [
    {
      ...
      description: "Trade across a wide range of assets and instruments",
      icon: BarChart2,
    },
    {
      number: "02",
  ...
  return (
    <div style={{
      ...
      <main style={{
        ...
        {/* Breakout Logo as clickable button */}
        <motion.div
        ...
        >
          ...
          <button
            ...
            aria-label="View Breakout details"
          >
            <div style={{
