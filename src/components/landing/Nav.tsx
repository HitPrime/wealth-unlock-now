  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-[oklch(0.10_0.04_300/0.6)] border-b border-[oklch(0.30_0.10_290/0.4)]">
      <div className="mx-auto max-w-7xl px-6 h-16 flex items-center justify-between">
        ...
        <StarterKitDialog
          trigger={
            <button className="inline-flex items-center rounded-full bg-purple-gradient px-7 py-3 text-base font-semibold text-white shadow-glow hover:brightness-110 transition">
              Get the Free Kit
            </button>
          }
        />
